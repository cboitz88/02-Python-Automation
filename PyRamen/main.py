...
menu_filepath = Path('/Users/boitz/Homework/python-homework/PyRamen/menu_data.csv')
sales_filepath = Path('/Users/boitz/Homework/python-homework/PyRamen/sales_data.csv')
